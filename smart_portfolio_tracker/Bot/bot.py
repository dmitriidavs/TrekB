...
class LiteBot(CoreBot):
    ...
    def __init__(self, api_token: str, arch_type: str, users_db_conn: str, util_db_host: str,
                 util_db_port: int, util_db: int, storage_type: str = 'memory'):

        super().__init__(api_token, storage_type, util_db_host, util_db_port, util_db)
        super().set_bot()
